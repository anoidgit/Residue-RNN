...
function ClipGradientFastResidueRecurrent:updateOutput(inputTable)
...
function ClipGradientFastResidueRecurrent:training()
	self.train=true
end

function ClipGradientFastResidueRecurrent:evaluate()
	self.train=false
end
