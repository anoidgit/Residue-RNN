require "nn"
local SecureClipGradientFastResidueRecurrent, parent = torch.class('nn.SecureClipGradientFastResidueRecurrent', 'nn.Module')

function SecureClipGradientFastResidueRecurrent:__init(inid, input, nstate, rinput, rstate, merge, transfer, maxgradient)
	parent.__init(self)
	self.output={}
	self.gradInput={}
	self.state={}
...
function SecureClipGradientFastResidueRecurrent:backward(inputTable, gradOutputTable, scale)
...
function SecureClipGradientFastResidueRecurrent:zeroGradParameters()
...
function SecureClipGradientFastResidueRecurrent:evaluate()
	self.train=false
end

function SecureClipGradientFastResidueRecurrent:__tostring__()
